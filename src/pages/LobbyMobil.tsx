...
import city from '../assets/Lobby/City.png'
import Godzilla from '../assets/Lobby/Godzilla.png'
import Gundam from '../assets/Lobby/Gundam.png'
import edificios from '../assets/Lobby/edificios.png'
import PopUp from '../assets/Lobby/PopUp.png'
import Nube1 from '../assets/Lobby/Nube1.png'
import Nube2 from '../assets/Lobby/Nube2.png'
import Nube3 from '../assets/Lobby/Nube3.png'
import Nube4 from '../assets/Lobby/Nube4.png'
import Nube5 from '../assets/Lobby/Nube5.png'
import Matrix from '../assets/Lobby/Matrix.png'
import IMG_Background from '../assets/Lobby/IMG_Background.png'
import IMG_PISO from '../assets/Lobby/IMG_PISO.png'
import FunLab from '../assets/Lobby/FunLab.png'
import Tv from '../assets/Lobby/Tv.png'
import Edificio1 from '../assets/Lobby/Edificio1.png'
import Edificio2 from '../assets/Lobby/Edificio2.png'
import workstation4 from '../assets/Lobby/workstation4.png'
import RightSide from '../assets/Lobby/RightSideCnp.png'
import LeftSide from '../assets/Lobby/LeftSideCnp.png'
import PingPong from '../assets/Lobby/PingPong.png'
import CoffeeBook from '../assets/Lobby/CoffeBook.png'
import Painting from '../assets/Lobby/Painting.png'
import workstation3 from '../assets/Lobby/workstation3.png'
import workstation1 from '../assets/Lobby/workstation.png'
import Alien_Yoga from '../assets/Lobby/Alien_Yoga.png'
import Tapete from '../assets/Lobby/Tapete.png'
import LobbyStars from '../assets/Lobby/LobbyStars.png'
import Brand_CNP from '../assets/Lobby/Brand_CNP.png'
        ...
        <Parallax ref={parallax} pages={2.25}>
          ...
          <ParallaxLayer style={{ zIndex: 2 }} offset={1.5} speed={0.2} factor={1}>
            <div className="centerDiv">
              ...
              <p style={{ paddingBottom: '58%', position: "absolute", zIndex: 3, color: "#00B8E6", fontSize: "12px" }} className='fontGoldenAge'>PLAY</p>
            </div>
          ...
          <ParallaxLayer style={{ zIndex: 2 }} offset={1.5} speed={1} factor={1}>
            <div className="splitCenterDiv">
              <img
                src={workstation1}
                className="lobby-Img"
          ...
          <ParallaxLayer style={{ zIndex: 2 }} offset={1.5} speed={0} factor={1}>
            <div className="centerDiv">
              <img src={Tapete} className="lobby-Img" style={{ width: '12%', paddingBottom: '0%', position: "relative", top: "5%" }} />
