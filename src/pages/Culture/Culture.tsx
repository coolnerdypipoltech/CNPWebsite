...
export default function Culture() {
  const videos = [
    ...
    },
    {
      ...
      description:
        'We took over the physical space with an augmented reality experience layered over the real world. ' +
        '<br />' +
        '<br />' +
        'Through a simple QR code, guests unlocked a creative dimension of the Costa brand, immersive, emotional, and full of surprises. Every corner became an interactive portal, turning exploration into play and physical presence into digital engagement.',
    },
    {
      title: 'Kimberly Clark Femenine Depend 360° CAMPAIGN',
      url: 'https://www.youtube.com/embed/ugICtFSwQgQ?si=q4SmhwvbGN5OdB2V',
      description:
        'We developed a campaign with Luz Elena Gonzalez, driving audience engagement by demystifying cultural tensions around the product and making a strong statement: a physiological condition does not define who you are.',
    },
    {
      title: 'YoYo The App',
      url: 'https://www.youtube.com/embed/rvFLh0HdQkQ?si=v6IeFupJQLCQKqE8',
      description:
        'We created an app that connects users with curated spots through a gamified journey, building a community that actively visits and engages with each venue. ' +
        '<br />' +
        '<br />' +
        'YoYo also generates valuable data while unlocking a hidden layer of the city — discover exclusive places, earn YoYo Credits, and redeem rewards inside its secret loop.',
    },
    {
      title: 'AXESS BY AXE: THE METAVERSE LOYALTY ECOSYSTEM',
      url: 'https://www.youtube.com/embed/QFPyvZ6eXmI?si=rSSn6gD3TO-eCA0K',
      description:
        'We imagined and built a gamified loyalty ecosystem that transforms entertainment into engagement - users compete inside a metaverse in virtual mini-games to earn points for exclusive concert access, creating a self-sustaining community of brand advocates.  ' +
        '<br />' +
        '<br />' +
      ...
      <div>
        ...
        <ParallaxLayer style={{ zIndex: 3 }} offset={0.5} speed={0.1} factor={1}>
           <p
              ...
              style={{ fontSize: '36px', color: 'white', position: 'relative', textAlign: "center" , paddingBottom: "32px" }}
            >
              Our work
            </p>
          <div
          ...
          >
            ...
            <p className="fontGoldenAgeOG" style={{ color: 'white', fontSize: '32px' }}>
              {videos[currentVideo].title}
            </p>
            <p
              className="fontGoldenAge"
              style={{ color: 'white', fontSize: '24px', width: '80%', textAlign: 'center', paddingBottom: '20px' }}
            >
        ...
        <ParallaxLayer style={{ zIndex: 6 }} offset={2.5} speed={0.25} factor={1}>
          <div className="centerDiv" style={{}}>
            ...
            <img
              ...
              style={{ width: '25vw', position: 'relative', right: '30%', top: '-45%' }}
            />
            <img src={CAT} className="imgHover"
              onClick={() => {
                window.open('https://www.tiktok.com/@animaldex/video/7442466728153451832?lang=es')
              }} style={{ width: '20vw', position: 'relative', right: '-22%', top: '-63%' }} />
            <img src={BOOK} className="imgHover" onClick={() => {
                window.open('https://www.goodreads.com/choiceawards/best-fiction-books-2022')
              }} style={{ width: '15vw', position: 'relative', left: '-25%', top: '-60%' }} />
          </div>
        </ParallaxLayer>

        <ParallaxLayer style={{ zIndex: 6 }} offset={3.4} speed={0.25} factor={1}>
          <div className="centerDiv" style={{}}>
            <img src={Nube2} style={{ width: '25vw', position: 'relative', right: '-30%', top: '30%' }} />
            ...
            <img src={FIGHT}  className="imgHover" onClick={() => {
                window.open('https://www.youtube.com/watch?v=WiMBO0BKeA4')
              }} style={{ width: '25vw', position: 'relative', left: '-30%', top: '-40%' }} />
              <img src={rose}  className="imgHover" onClick={() => {
                window.open('https://www.youtube.com/watch?v=upDsr150ioc')
              }} style={{ width: '25vw', position: 'relative', right: '-25%', top: '-100%' }} />
            
          </div>
        </ParallaxLayer>

        <ParallaxLayer style={{ zIndex: 2 }} offset={4.3} speed={0.3} factor={0.25}>
          <div
            className="centerDiv"
            style={{ alignItems: 'flex-start', paddingLeft: '10%', justifyContent: 'flex-start' }}
          >
        ...
        <ParallaxLayer style={{ zIndex: 5 }} offset={4.2} speed={0.3} factor={0.2}>
          <div
            className="centerDiv"
            style={{
              alignItems: 'flex-end',
          ...
          >
            <p className="grad1">Creativity in hyperdrive,</p>
            <p className="grad1"> guided by cultural gravity</p>
          </div>
        </ParallaxLayer>

        <ParallaxLayer style={{ zIndex: 4 }} offset={4.5} speed={0.3} factor={1}>
          <div className="centerDiv" style={{}}>
            <img src={Nube3} style={{ width: '25vw', position: 'relative', right: '-30%', top: '0%' }} />
            <img src={Blackhorse} className="imgHover" onClick={() => {
                window.open('https://www.youtube.com/watch?v=ETYNfedQ2xk')
              }}  style={{ width: '25vw', position: 'relative', right: '-25%', top: '-35%' }} />
        ...
        <ParallaxLayer style={{ zIndex: 3 }} offset={4.5} speed={0.3} factor={0.2}>
          <div
            className="centerDiv"
            style={{
              alignItems: 'flex-end',
        ...
        <ParallaxLayer style={{ zIndex: 3 }} offset={5} speed={0.25} factor={1}>
          <div className="splitCenterDiv">
            <img src={Nube4} style={{ width: '28vw', marginLeft: '20%' }} />
            <img
              src={Dios}
              className="imgHover" 
              style={{ width: '50vw', position: 'relative', right: '2%', top: '-5%' }}
              onClick={() => {
