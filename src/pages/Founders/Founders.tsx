      ...
      <div>
        ...
        <ParallaxLayer style={{ zIndex: 1 }} offset={0.15} speed={0.2} factor={0.1}>
          <div className="centerDiv" style={{ justifyContent: 'center' }}>
            <p className="fontGoldenAge" style={{ fontSize: '1vw', fontWeight: 'bold' }}>
              {' '}
            ...
            >
              ...
              <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                {showFounder2Text && (
                  ...
                  >
                    <img  src={IMG_Dial_Andrea} style={{ width: '30VW' }} />
                    <img onClick={handleFounder2Click} className='xButtonFounder'  src={xButton} style={{ width: '40px', position: "relative", top: '-10.5vw', right: '31vw', cursor: 'pointer' }} />
